...
namespace Program
{
    public class Solver
    {
        public void Solve()
        {
            var perm = new ModInteger[200050];
            perm[0] = 1;
            ...
            var k = sc.Integer();
            var u = perm[n + k - 1];
            var l = perm[k] * perm[n - 1];
            IO.Printer.Out.WriteLine(u * InverseElement(l.num, ModInteger.Mod));
        ...
        static public long InverseElement(long num, long mod)
        {
